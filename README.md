...
To build the final jar and optimize the takeout application for production, run:
...
Then navigate to [http://localhost:5500](http://localhost:5500) in your browser.
